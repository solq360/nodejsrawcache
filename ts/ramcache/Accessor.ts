...
interface Accessor {
    ...
    /***加载实体*/
    load(name: EntityName, id: any, loadCallback: (res: any) => Entity, resultCallBack: (res: any) => void): void;
    /***删除实体*/
    ...
    /*
        ...
        updateSync(name: EntityName, entity: Entity): void;
        loadSync(name: EntityName, id: any): Entity;
        removeSync(name: EntityName, entity: Entity): void;
        */
...
class TimerAccessor implements Accessor {
    ...
    /***加载实体*/
    public load(name: EntityName, id: any, loadCallback: (res: any) => any, resultCallBack: (res: any) => void): void {
